  ...
  return (
    <footer className="border-t border-black/5 dark:border-white/5 py-8 mt-auto bg-white/50 dark:bg-zinc-950/50 relative">
      <div className="w-full max-w-7xl mx-auto px-4 text-center">
        <p className="text-zinc-500 dark:text-zinc-400 font-medium text-[10px] sm:text-xs md:text-sm mb-4 sm:mb-6 max-w-full lg:whitespace-nowrap leading-relaxed uppercase">
