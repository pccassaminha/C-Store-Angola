  ...
  if (items.length === 0) {
    return (
      <main className="pt-32 pb-20 flex-1 flex flex-col items-center justify-center text-center px-6">
        ...
        <button 
          onClick={() => navigate(urlSlug ? `/store/${urlSlug}` : '/')}
  ...
  return (
    <main className="pt-32 pb-20 flex-1">
      <section className="max-w-3xl mx-auto px-6">
        <div className="bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/5 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-sm dark:shadow-none">
          ...
          <form onSubmit={handleWhatsApp} className="space-y-6">
            ...
            >
              ...
              <span className="text-base sm:text-lg">Finalizar via WhatsApp</span>
            </button>
          </form>
        </div>
      </section>
